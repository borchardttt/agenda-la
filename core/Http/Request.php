...
class Request
{
   ...
   */
    ...
    public static function makeGet(array $params = [], string $uri = '/'): self
    {
        return new self($params, 'GET', $uri);
    }

    public static function makePost(array $params = [], string $uri = '/'): self
    {
        return new self($params, 'POST', $uri);
    }
}
